...
public class GetGithubUserAvatarTask extends AsyncTask<String, Void, Bitmap> {
    ...
    //    public void downloadAvatar(ImageView imageView, boolean notify){
//        if(this.avatar == null) {
//            try {
//                this.mDownloadTask = new GetGithubUserAvatarTask();
//                this.avatar = this.mDownloadTask.execute(avatar_url).get();
//                if(imageView != null) imageView.setImageBitmap(this.avatar);
//                if(notify) this.notifyAll();
//            } catch (Exception e) {
//                Log.e("DOWNLOAD", "Could not download avatar for user: " + login);
//                e.printStackTrace();
//            }
//        }
//    }
